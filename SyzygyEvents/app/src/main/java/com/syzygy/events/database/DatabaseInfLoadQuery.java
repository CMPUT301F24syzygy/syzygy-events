 ...
 */
@Database.Dissolves
public class DatabaseInfLoadQuery<T extends DatabaseInstance<T>> implements Database.UpdateListener, Database.Querrier<DatabaseInfLoadQuery<T>>, Database.Dissolvable {
