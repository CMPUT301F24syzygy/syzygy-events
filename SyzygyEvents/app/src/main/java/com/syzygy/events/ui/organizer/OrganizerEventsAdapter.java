    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            view = LayoutInflater.from(getContext()).inflate(
                    R.layout.item_org_event_list, parent, false);
        }
        ...
        TextView weekdays = view.findViewById(R.id.organizer_events_item_weekdays_text);
        weekdays.setText(event.getFormattedEventDates());

        TextView address = view.findViewById(R.id.organizer_events_item_location_text);
